...
export default {
    ...
    mounted() {
        ...
        var select = function (s) {
            ...
            // 使用 lottie.loadAnimation 方法來加載動畫
        ...
        // 監聽 DOMLoaded 事件，當動畫的 DOM 加載完成時執行 onDOMLoaded 函數
...
<template>
    ...
    <section class="videoArea area">
        <div class="theVideo">
            <!-- 嵌入 MP4 视频，并在组件加载后自动播放 -->
            <video ref="video" controls autoplay loop muted>
                <source src="@/assets/106499-673008260.mp4" type="video/mp4">
            </video>
        </div>
        ...
        <div id="app">
            <div class="title_area">
                ...
                <hr />
                <h2 v-if="selectedPlace">{{ selectedPlace.place }}{{ selectedPlace.tag }}</h2>
                <h3 v-if="selectedPlace">{{ selectedPlace.available }}</h3>
            </div>

            <svg id="cf503461-00bd-459a-aeb5-062ebc913211" data-name="圖層 1" xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 595.28 841.89">
                <!-- <defs> 元素用於定義可重复使用的圖形元素或屬性 -->
                <defs></defs>
                <title></title>

                <path id="302f43cb-d765-4d82-8054-45eb380ec9ba" data-name="path2464"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M74.57,416v0Z" />
                ...
                <path id="28bff46b-f2eb-45d7-8426-8f17aad842d2" data-name="path2468"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M92.75,406.85l1.58-.24L94,407.83l-1.22-1Z" />

                <path id="f2be3e90-3318-427f-a854-c65a6fa8d146" data-name="path2470"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M63.72,439.41l-.12,1.71,1.46-.61-1.34-1.1Z" />
                <!-- 虎井嶼 -->
                ...
                <a v-for="place in penghu_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/c6734245d2e124fbf4b25d458ddfd84b" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 澎湖縣 -->
                ...
                <path id="7490e04c-2b1a-4fed-885e-81a321fa81f0" data-name="path2494"
                    class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M64.84,493.34l.17,1.29,1.12.09-.69-.95-.6-.43Z" />
                <!-- 西吉嶼 -->
                ...
                <a v-for="place in chiayi_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/cdb880ada35d3a78fabadcfad8971c0c" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 嘉義縣 -->
                ...
                <a v-for="place in taichung_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/fd423d9ce079b080137a5619601b9f6e" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 台中市 -->
                ...
                <a v-for="place in keelung_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/d9b758f9aee09cadcf4c2b13ad589534" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 基隆市 -->
                ...
                <a v-for="place in pingtung_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/83f1843e8ce0cea0ddd592dd606c20db" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 屏東縣 -->
                    ...
                    <!-- 小琉球 -->
                    <path id="161d6372-ac8f-409c-ad51-9db7795c8614" data-name="Liuqiu_Township"
                        class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9"
                ...
                <a v-for="place in taipei_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/1c397bf4659ccc971957802490ae936e" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 台北市 -->
                ...
                <a v-for="place in new_taipei_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/b3fe0a4eb74233357f1d18f00a1d3d41" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 新北市 -->
                ...
                <a v-for="place in yilan_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/95bd32a797a65b6cb8504c2639197feb" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 宜蘭縣 -->
                ...
                <a v-for="place in taoyuan_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/1e6f1069a0a963a715165e20cdc8d8c8" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 桃園市 -->
                ...
                <a v-for="place in hsinchu_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/7bdf32daca14987968164887e98abea0" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 新竹市 -->
                ...
                <a v-for="place in hsinchu_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/fbae5926225ea1ed0a8b1b1ff11496d0" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 新竹縣 -->
                ...
                <a v-for="place in miaoli_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/3bb4e1b75d345d7684766c7efa055594" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 苗栗縣 -->
                ...
                <a v-for="place in changhua_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/14a81fdcc1760e3894b0f69cc03a15da" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 彰化縣 -->
                ...
                <a v-for="place in yunlin_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/53cea69d64b58868d0a05ccd988a0d99" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 雲林縣 -->
                ...
                <a v-for="place in hualien_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/656d8a23246492b2dc17fdc5faf8f28e" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 花蓮縣 -->
                ...
                <a v-for="place in nantou_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/55061cdcd45c6d6576e5d07809746927" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 南投縣 -->
                ...
                <a v-for="place in taitung_country" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/68b899eb08a6f308ec6dc4d10db0f046" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 台東縣 -->
                ...
                <a v-for="place in tainan_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/ef92ac8a62b86d7e763275658d635a8f" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 台南市 -->
                ...
                <a v-for="place in kaohsiung_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/7bbd1e0a97da4ac986ac273daed43198" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 高雄市 -->
                ...
                <a v-for="place in chiayi_city" :class="place.tag" @mouseover="showInfo(place)"
                    href="https://cn.batchgeo.com/map/7249a78c9e36f00d0d8fd8c423232497" target="_blank">
                    <rect x="x_value" y="y_value" width="width_value" height="height_value" fill="transparent" />
                    <!-- 嘉義市 -->
                ...
                <path id="d280cd89-2c2b-4087-8467-d9f6efea93ec" data-name="path3219"
                    class="e8e3f4a4-ad34-4cc6-9b06-8353f08c9353"
                ...
                <g id="f292dbb8-1f08-451f-af4d-83b2a6953aa2" data-name="kinmen_country">
                    ...
                    <path id="87972721-81c8-4058-acb3-6963aa0ed3e0" data-name="path2655"
                        class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M107.46,220l-.75.25.31.31H108l-.5-.56h0Z" />
                    <path id="1618ff3b-8feb-42b3-b000-0d7dc2b4b993" data-name="path2657"
                        class="96fdfe13-4732-40bb-9e9c-cdc6e310fcb9" d="M111.85,244l-.38.38.88-.06-.5-.31Z" />
                </g>
                ...
                <g id="13520621-f1ed-4c7b-8b5d-1a169d9bf935" data-name="g4313">
                    ...
                    <path id="017d8352-40c4-43f3-b3c3-4910f7ad1925" data-name="path2671"
                        class="bc4bd339-f614-4405-a1f2-7f894051d5a3" d="M49,147.87h4.07L51.76,150l-3-.27.27-1.9Z" />
                    <!-- 莒光 -->
                    <path id="4330177a-8933-40bc-981d-f25c97f05ea3" data-name="path2673"
                        class="bc4bd339-f614-4405-a1f2-7f894051d5a3"
                    ...
                    <path id="93c9a64a-04f8-4a19-bcbb-08dba5cbc5cd" data-name="path2677"
                        class="bc4bd339-f614-4405-a1f2-7f894051d5a3" d="M59.09,103.62l.81,1.63-.81-1.63Z" />
                    <!-- 北竿鄉 -->
                    ...
                    <!-- 在SVG（可伸缩矢量图形）中，通常使用路径（Path）来描述图形的轮廓。
          举个例子，考虑路径中的第一个点 "M58,91.41"：
          'M' 是路径命令，表示移动到指定的坐标位置。
          '58' 是 x 坐标的值。
          '91.41' 是 y 坐标的值。
          路径中其他的命令和坐标依次类推。
          总结一下：
          'M' 表示移动到指定坐标位置。
          'l' 表示从当前位置画一条直线到指定坐标位置。
          'Z' 表示闭合路径，将当前位置与路径的起始位置相连接，形成封闭的图形。 -->
                    <!-- 高登島 -->
                    ...
                    <path id="3dc2b0c9-caa5-41e4-a9fd-9ba7b2a05d51" data-name="path2683"
                        class="bc4bd339-f614-4405-a1f2-7f894051d5a3" d="M66.42,84.62l-1.9,1.9L67.23,86l-.82-1.36Z" />
                    <!-- 東引鄉 -->
    ...
    <link rel="stylesheet" href="TaiwanChargeMap.css">
</template>
